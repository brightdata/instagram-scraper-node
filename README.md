...
[![last verified](https://img.shields.io/badge/last%20verified-24%20Sep%202026-brightgreen)](https://github.com/brightdata/instagram-scraper-node/actions/workflows/live.yml) <!-- verified: rewritten by the daily run -->
...
Bugs in this repo:
[open an issue](https://github.com/brightdata/instagram-scraper-node/issues), and
